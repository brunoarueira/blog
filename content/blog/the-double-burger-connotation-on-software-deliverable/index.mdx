...
At software projects, we're facing situations like the connotation above. A customer wants a simple
change or request, not so simple at the majority of requests, to avoid lose a customer, tries to
...
![<a href="https://vincentdnl.com/drawings/technical-debt" target="_blank" rel="noopener noreferrer">Image from Vincent Deniel</a>](./technical-debt.png 'Technical Debt')
...
Sometimes it's better to say no to a customer and reject a simple request on a software development
world, to say yes and deliver a mislead or broken feature. Therefore, with more plan and analysis is
far better to deliver even a simple but more robust, correct, focused customer deliverable with room
